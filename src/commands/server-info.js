...
module.exports.run = (client, message, args) => {
	const guild = message.guild,
		...
		embed = new client.Discord.MessageEmbed()
			...
			.addField('_Dueño del Servidor_', guild.owner.user.tag, true).addField('_ID_', guild.id, true)
			.addField('_Region_', region[guild.region], true).addField('_Miembros_', guild.memberCount.toLocaleString(), true)
