 ...
 * @param {Number} maxTextLength Si el texto resultante es mayor a esta longitud, detener el bucle
...
function getWellText(text, maxWordLength, maxTextLength = Infinity) {
  ...
  for (let i = 0; i < text.length; i++) {
    ...
    //Si la longitud de la palabra a revisar es mayor a la longitud de palabra especificado....
