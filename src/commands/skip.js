module.exports.run = async (client, message) => {
	...
	if (fetched.songs[0].vote.includes(message.member.id)) {
		...
		return message.channel.send(`Has quitado tu voto! ${fetched.songs[0].vote.length}/${required} requeridos.`);
	}
...
module.exports.help = {
	name: 'skip',
	description: 'cansado de escuchar musica aburrida para esperar la favorita? esta es la perfecta opcion!',
};
